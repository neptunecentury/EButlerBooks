    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    FeaturedBookId = table.Column<int>(type: "int", nullable: true),
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, false, "A book about a dark world.", "In a world where darkness is everywhere, one woman fights to bring it light.", null, false, null, "Dark World", null },
                    { 2, false, "Robots. A.I.", "Angie Gordon get trapped in her worst nightmare", null, false, null, "Angie Gordon", null },
                    { 3, false, "Boy kidnaps girl", "Boy kidnaps girl and takes her to a fantasy realm to help him find his long-lost sister.", null, false, null, "Fantasy", null }
                });
